var datainfo = {
	...
	tab_list: [{
		...
		active: "active",	
		src:
		'<input class="input-small" type="text" id="inputEmail" placeholder="登录用户">'
	},{
		num: 2,
		name: "输入框(后缀)",
		src:
		'<div class="input-append">'+
		'	<input class="input-small" id="prependedInput" type="text" placeholder="Username">'+
		...
		src:
		'<input class="input-small" type="text" id="inputEmail" placeholder="登录用户">'+
		'<div class="ml5 input-append">'+
		'	<input class="input-small" id="prependedInput" type="text" placeholder="Username">'+
		'	<span class="add-on add-on-fixedlast4ie78"><button class="btn"><i class="icon-chevron-down"></i></button></span>'+
		'</div>'+
		'<div class="ml5 input-prepend">'+
		'	<span class="add-on"><button class="btn"><i class="icon-chevron-down"></i></button></span>'+
		'	<input class="input-small" id="prependedInput" type="text" placeholder="Username">'+
		'</div>',
		todo:
		'1、合适的控制每个输入框的宽度'
